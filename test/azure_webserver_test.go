...
var subscriptionID string = "e5c7dd98-c095-46ec-9079-851589b94248"
...
func TestAzureLinuxVMUbuntuVersion(t *testing.T) {
	...
	// checks if the vm that was created has the same os version that was declared
...
func TestAzureNicExistsAndConnectedVm(t *testing.T) {
	...
	// Checks if nic is connected to the vm
